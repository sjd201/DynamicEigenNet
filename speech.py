...
def listen_print_loop(responses, audio_stream):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            if re.search(r'\b(exit|quit)\b', transcript, re.I):
                ...
                audio_stream.pause() # to avoid transcribing the speech being generated
                processInput(transcript.strip())
